...
export interface ISwitchboardEventsInterface extends utils.Interface {
  functions: {};
...
export interface ISwitchboardEvents extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISwitchboardEventsInterface;
