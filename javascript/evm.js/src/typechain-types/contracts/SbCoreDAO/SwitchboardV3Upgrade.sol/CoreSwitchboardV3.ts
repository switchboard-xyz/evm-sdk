...
export declare namespace CoreSwitchboardV3 {
  ...
  export type AggregatorStruct = {
    ...
    latestResult: CoreSwitchboardV3.ResultStruct;
  ...
  export type AggregatorStructOutput = [
    string,
    string,
    CoreSwitchboardV3.ResultStructOutput,
    BigNumber,
    BigNumber,
    BigNumber,
    string,
    ...
    name: string;
    authority: string;
    latestResult: CoreSwitchboardV3.ResultStructOutput;
    batchSize: BigNumber;
...
export interface CoreSwitchboardV3Interface extends utils.Interface {
  functions: {
...
export interface CoreSwitchboardV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CoreSwitchboardV3Interface;
  ...
  functions: {
    ...
    getAggregatorsByAuthority(
      ...
      overrides?: CallOverrides
    ): Promise<[string[], CoreSwitchboardV3.AggregatorStructOutput[]]>;
    ...
    sortResults(
      input: CoreSwitchboardV3.ResultStruct[],
      overrides?: CallOverrides
