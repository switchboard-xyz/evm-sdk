...
export declare namespace AttestationServiceStructs {
...
export interface CoreSwitchboardAttestationServiceInterface
...
export interface CoreSwitchboardAttestationService extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CoreSwitchboardAttestationServiceInterface;
  ...
  functions: {
    ...
    getFunctionsByAuthority(
      ...
      overrides?: CallOverrides
    ): Promise<[string[], AttestationServiceStructs.FunctionStructOutput[]]>;
