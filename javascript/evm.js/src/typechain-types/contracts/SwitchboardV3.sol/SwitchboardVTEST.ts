...
export declare namespace SwitchboardVTEST {
  ...
  export type AggregatorStruct = {
    ...
    latestResult: SwitchboardVTEST.ResultStruct;
  ...
  export type AggregatorStructOutput = [
    string,
    string,
    SwitchboardVTEST.ResultStructOutput,
    BigNumber,
    BigNumber,
    BigNumber,
    string,
    ...
    name: string;
    authority: string;
    latestResult: SwitchboardVTEST.ResultStructOutput;
    batchSize: BigNumber;
...
export interface SwitchboardVTESTInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [SwitchboardVTEST.ResultStruct[]]
  ): string;
...
export interface SwitchboardVTEST extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwitchboardVTESTInterface;
  ...
  functions: {
    ...
    getAggregatorsByAuthority(
      ...
      overrides?: CallOverrides
    ): Promise<[string[], SwitchboardVTEST.AggregatorStructOutput[]]>;
    ...
    sortResults(
      input: SwitchboardVTEST.ResultStruct[],
      overrides?: CallOverrides
    ): Promise<[SwitchboardVTEST.ResultStructOutput[]]>;
