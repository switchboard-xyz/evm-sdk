...
export declare namespace SwitchboardV3 {
  ...
  export type AggregatorStruct = {
    ...
    latestResult: SwitchboardV3.ResultStruct;
  ...
  export type AggregatorStructOutput = [
    string,
    string,
    SwitchboardV3.ResultStructOutput,
    BigNumber,
    BigNumber,
    BigNumber,
    string,
    ...
    name: string;
    authority: string;
    latestResult: SwitchboardV3.ResultStructOutput;
    batchSize: BigNumber;
...
export interface SwitchboardV3Interface extends utils.Interface {
  functions: {
    ...
    "setQueueVerificationService(address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "aggregatorToLegacyAdapter",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getReadyAggregators",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "initSwitchboardV3",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "oracleQueueToServiceQueue",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "queuePermissions",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setQueueVerificationService",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface LegacyOracleAdapterDeployedEventObject {
  aggregatorAddress: string;
  legacyAdapterAddress: string;
}
export type LegacyOracleAdapterDeployedEvent = TypedEvent<
  [string, string],
  LegacyOracleAdapterDeployedEventObject
>;

export type LegacyOracleAdapterDeployedEventFilter =
  TypedEventFilter<LegacyOracleAdapterDeployedEvent>;
...
export interface SwitchboardV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwitchboardV3Interface;
  ...
  functions: {
    ...
    createAggregator(
      ...
      supportLegacyAggregator: PromiseOrValue<boolean>,
    ...
    getAggregatorsByAuthority(
      ...
      overrides?: CallOverrides
    ): Promise<[string[], SwitchboardV3.AggregatorStructOutput[]]>;
    ...
    getMedian(
      arr: SwitchboardV3.ResultStruct[],
      overrides?: CallOverrides
    ...
    setAggregatorReadConfig(
      ...
      legacyAdapterEnabled: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setQueueVerificationService(
      queueAddress: PromiseOrValue<string>,
      serviceQueueAddress: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "LegacyOracleAdapterDeployed(address,address)"(
      aggregatorAddress?: PromiseOrValue<string> | null,
      legacyAdapterAddress?: PromiseOrValue<string> | null
    ): LegacyOracleAdapterDeployedEventFilter;
    LegacyOracleAdapterDeployed(
      aggregatorAddress?: PromiseOrValue<string> | null,
      legacyAdapterAddress?: PromiseOrValue<string> | null
    ): LegacyOracleAdapterDeployedEventFilter;
