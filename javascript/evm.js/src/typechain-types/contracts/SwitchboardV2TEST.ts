...
export declare namespace SwitchboardV2TEST {
  ...
  export type AggregatorStruct = {
    ...
    latestResult: SwitchboardV2TEST.ResultStruct;
  ...
  export type AggregatorStructOutput = [
    string,
    string,
    SwitchboardV2TEST.ResultStructOutput,
    BigNumber,
    BigNumber,
    BigNumber,
    string,
    ...
    name: string;
    authority: string;
    latestResult: SwitchboardV2TEST.ResultStructOutput;
    batchSize: BigNumber;
...
export interface SwitchboardV2TESTInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [SwitchboardV2TEST.ResultStruct[]]
  ): string;
  encodeFunctionData(
...
export interface SwitchboardV2TEST extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwitchboardV2TESTInterface;
  ...
  functions: {
    ...
    getAggregatorsByAuthority(
      ...
      overrides?: CallOverrides
    ): Promise<[string[], SwitchboardV2TEST.AggregatorStructOutput[]]>;
    ...
    getMedian(
      arr: SwitchboardV2TEST.ResultStruct[],
      overrides?: CallOverrides
    ...
    sortResults(
      input: SwitchboardV2TEST.ResultStruct[],
      overrides?: CallOverrides
    ): Promise<[SwitchboardV2TEST.ResultStructOutput[]]>;
