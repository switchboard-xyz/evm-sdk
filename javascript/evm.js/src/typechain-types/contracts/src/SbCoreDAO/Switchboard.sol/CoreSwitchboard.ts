...
export declare namespace CoreSwitchboard {
  ...
  export type AggregatorStruct = {
    ...
    latestResult: CoreSwitchboard.ResultStruct;
  ...
  export type AggregatorStructOutput = [
    string,
    string,
    CoreSwitchboard.ResultStructOutput,
    BigNumber,
    BigNumber,
    BigNumber,
    string,
    ...
    name: string;
    authority: string;
    latestResult: CoreSwitchboard.ResultStructOutput;
    batchSize: BigNumber;
...
export interface CoreSwitchboardInterface extends utils.Interface {
  functions: {
    ...
    "insertionSortResults((int256,uint256,address)[])": FunctionFragment;
    ...
    "quickSortResults((int256,uint256,address)[])": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [CoreSwitchboard.ResultStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "insertionSortResults",
    values: [CoreSwitchboard.ResultStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "quickSortResults",
    values: [CoreSwitchboard.ResultStruct[]]
  ): string;
  encodeFunctionData(
...
export interface CoreSwitchboard extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CoreSwitchboardInterface;
  ...
  functions: {
    ...
    getAggregatorsByAuthority(
      ...
      overrides?: CallOverrides
    ): Promise<[string[], CoreSwitchboard.AggregatorStructOutput[]]>;
    ...
    getMedian(
      arr: CoreSwitchboard.ResultStruct[],
      overrides?: CallOverrides
    ...
    insertionSortResults(
      arr: CoreSwitchboard.ResultStruct[],
      overrides?: CallOverrides
    ): Promise<[CoreSwitchboard.ResultStructOutput[]]>;
